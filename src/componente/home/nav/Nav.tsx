function Nav() {
  ...
  <div className="flex md:order-2">
        ...
        <img className="w-5 h-5" aria-hidden="true" src="menu_burguer4.svg"/>            
          
  </div>
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      <div className="relative mt-3 md:hidden">
        <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
          <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="menu_burguer.svg" fill="none" viewBox="0 0 20 20">
      ...
      <div className="flex flex-col items-center">
        <img src="cesta.svg" alt="cesta" className="" />
        <span className=" font-medium text-sm">Compras</span>
        </div>
    
  </div>
  <div className="flex flex-col items-start">
      <i>Apoie a agricultura familiar </i>
        <p className=" font-medium">e saboreie o melhor da terra!</p>
        </div>
</nav>
